...
export interface CompletecorporateMember
  extends z.infer<typeof corporateMemberModel> {
 ...
 */
export const RelatedcorporateMemberModel: z.ZodSchema<CompletecorporateMember> =
  z.lazy(() =>
    corporateMemberModel.extend({
