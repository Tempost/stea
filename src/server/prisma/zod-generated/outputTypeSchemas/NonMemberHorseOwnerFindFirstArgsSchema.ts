...
export const NonMemberHorseOwnerFindFirstArgsSchema: z.ZodType<Prisma.NonMemberHorseOwnerFindFirstArgs> = z.object({
...
export default NonMemberHorseOwnerFindFirstArgsSchema;
