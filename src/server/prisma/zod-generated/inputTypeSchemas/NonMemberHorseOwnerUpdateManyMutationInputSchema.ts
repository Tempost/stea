...
export const NonMemberHorseOwnerUpdateManyMutationInputSchema: z.ZodType<Prisma.NonMemberHorseOwnerUpdateManyMutationInput> = z.object({
...
export default NonMemberHorseOwnerUpdateManyMutationInputSchema;
