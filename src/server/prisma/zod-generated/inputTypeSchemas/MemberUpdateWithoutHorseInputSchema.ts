...
import { RiderComboUpdateManyWithoutMemberNestedInputSchema } from './RiderComboUpdateManyWithoutMemberNestedInputSchema';

export const MemberUpdateWithoutHorseInputSchema: z.ZodType<Prisma.MemberUpdateWithoutHorseInput> = z.object({
  ...
  currentUSEAMember: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  RiderCombo: z.lazy(() => RiderComboUpdateManyWithoutMemberNestedInputSchema).optional(),
}).strict();

export default MemberUpdateWithoutHorseInputSchema;
