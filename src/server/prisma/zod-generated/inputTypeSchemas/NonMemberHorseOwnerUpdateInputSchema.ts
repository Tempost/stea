...
import { HorseUpdateManyWithoutOwnerRecNestedInputSchema } from './HorseUpdateManyWithoutOwnerRecNestedInputSchema';

export const NonMemberHorseOwnerUpdateInputSchema: z.ZodType<Prisma.NonMemberHorseOwnerUpdateInput> = z.object({
