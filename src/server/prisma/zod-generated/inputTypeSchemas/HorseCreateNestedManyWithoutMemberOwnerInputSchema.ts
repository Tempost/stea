...
export const HorseCreateNestedManyWithoutMemberOwnerInputSchema: z.ZodType<Prisma.HorseCreateNestedManyWithoutMemberOwnerInput> = z.object({
...
export default HorseCreateNestedManyWithoutMemberOwnerInputSchema;
