...
export const PointsCreateNestedManyWithoutShowInputSchema: z.ZodType<Prisma.PointsCreateNestedManyWithoutShowInput> = z.object({
...
export default PointsCreateNestedManyWithoutShowInputSchema;
