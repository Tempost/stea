...
import { ShowUpdateToOneWithWhereWithoutPointsInputSchema } from './ShowUpdateToOneWithWhereWithoutPointsInputSchema';
...
export const ShowUpdateOneRequiredWithoutPointsNestedInputSchema: z.ZodType<Prisma.ShowUpdateOneRequiredWithoutPointsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ShowUpdateToOneWithWhereWithoutPointsInputSchema),z.lazy(() => ShowUpdateWithoutPointsInputSchema),z.lazy(() => ShowUncheckedUpdateWithoutPointsInputSchema) ]).optional(),
}).strict();
